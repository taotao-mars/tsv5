...
def run_exposure_s3_snapshot_rolling(
    ...
    Output layout:
      ../exposure_full/
        ...
        exposure_hat_for_demand_full.csv
        exposure_rolling_summary.csv
        exposure_rolling_errors.csv
    ...
    full_hat_csv = output_root / "exposure_hat_for_demand_full.csv"
    summary_csv = output_root / "exposure_rolling_summary.csv"
    errors_csv = output_root / "exposure_rolling_errors.csv"
...
# ============================================================
# FINAL USAGE — only usage block retained
# ============================================================
# S3 bucket and prefix are already configured in this file.
# Results are written to ../exposure_full/ and no SCOT join is performed.
#
# First smoke test: 5000 ASINs, two earliest snapshots, three epochs.
#
# %run -i tcn_exposure_v2_v27_8h_S3_ROLLING_EXPOSURE_FULL_FOLDER.py
#
# rolling_result = run_exposure_s3_snapshot_rolling(
#     n_asins=5000,
#     max_snapshots=2,
#     select_latest=False,
#     epochs=3,
...
# )
#
# After the smoke test succeeds, run all snapshots and all ASINs:
#
# rolling_result = run_exposure_s3_snapshot_rolling(
#     n_asins=None,
#     max_snapshots=None,
