...
class DecoderPeakCrossAttention(nn.Module):
    ...
    """
    def __init__(self, d_model=32, context_dim=2, horizon=20, n_heads=4,
...
def run_demand_current_best_instock_only(
    ...
    ``exposure_hat_for_demand.csv`` from the current working directory.
    """
...
# ============================================================
# RECOMMENDED JUPYTER USAGE (LOCAL CSV)
# ============================================================
# %run -i demand_external_exposure3_v12c2_FUTURETCN_DECODER_STOPGRAD_Z_LOCALCSV_FIXED.py
#
...
# )
#
# The same function also accepts an in-memory exposure result:
# demand_result_instock_v12 = run_demand_current_best_instock_only(
#     data_raw1=data_raw1,
#     scot_df=scot_df,
