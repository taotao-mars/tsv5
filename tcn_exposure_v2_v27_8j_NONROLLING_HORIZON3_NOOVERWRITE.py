# =====================================================
# v27.8j NON-ROLLING HORIZON-3 TEST
# - Based on v27.8e non-rolling exposure model
# - Forecast horizon changed from 20 weeks to 3 weeks
# - Default output CSV is unique and will not overwrite the 20-week hat
# =====================================================
...
def run_exposure_v2_final_scot_5000(
    ...
    batch_size=128,
    use_encoder_self_attn=True,
    save_hat_csv_path="exposure_hat_for_demand_h3_nonrolling.csv",
    hat_variant_for_demand="base",
    exposure_hat_scale=1.0,
    exposure_hat_blend_q70_weight=0.30,
    residual_scale=1.7,
...
# ============================================================
# %run -i tcn_exposure_v2_v27_8j_NONROLLING_HORIZON3_NOOVERWRITE.py
#
